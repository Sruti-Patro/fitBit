...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <Link to="/">
                <img
                    className="mx-auto h-100 w-auto right-50"
                    src={FitBit}
                    alt="FitBit Logo"
                />
                </Link>
                        ...
                        <div className="mt-6 grid grid-cols-3 gap-3">
                            <div>
                                ...
                                >
                                    ...
                                    <svg className="w-5 h-5" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <svg className="h-5 w-5" viewBox="0 -4 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
